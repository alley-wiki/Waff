    ...
    <div className={`wiki-page ${isDarkMode ? 'dark-theme' : ''}`}>
      ...
      <main className="main-content">
        ...
        <div className="content-box">
          ...
          <p>
            Вишнёвые аллеи - <a href="https://discord.gg/xqTMDz7CXK" className="link">дискорд-сервер</a>, который был создан для общения и поддержки автора <a href="/Cherru/" className="link">Cherru</a> (художница/аниматорша). Основная тематика сервера - майнкрафт ютубер <a href='https://www.youtube.com/@MrLololoshka' className='link'>MrLololoshka</a> и сама художница. Сервер был создан 24 июля 2022 года, но был открыт 1-го августа 2022-го года. Помощь с созданием сервера художнице (Cherru) предложил <a href='/Dunkan' className='link'>Дункан</a> (duncan_reivun), который и заложил первый и значимый фундамент для всего сервера.
          </p>
        </div>
      </main>
    </div>
