        ...
        <div className="content-layout">
          <div className="content-wrapper">
            <div className="main-info section">
              ...
              <p>30 июля 2022 г. один из старых знакомых <a href='/Cherru' className='link'>Черр</a> скинул ссылку на приватный дружеский сервер (где находилась Вафф), ведущий на её видеоролик, с анимацией под названием "punk tactics" (на данный момент анимация недоступна и скрыта). Вафф сразу узнала стиль Черр и перешла по ссылке, подписалась на канал старой подруги, начав активно следить за творчеством авторши.
